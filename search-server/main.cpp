...
public:
	...
	vector<Document> FindTopDocuments(const string& raw_query, PredicateDocFilter predicate) const {
	...
	vector<Document> FindTopDocuments(const string& raw_query, DocumentStatus status_) const {
		return FindTopDocuments(raw_query, [status_]
		(int document_id, DocumentStatus status, int rating) { return status == status_; });
	}
...
private:
	...
	template <typename PredicateDocFilter>
	vector<Document> FindAllDocuments(const Query& query, PredicateDocFilter predicate) const {
